...
- **Benefit:** Enables queries like "Show me all _Financial_ links > R100,000".

**Implementation Checklist:**

- [x] Add `scope` property to XFields (`terms` | `relations` | `both`)
- [x] Update XField dialog UI with scope selector
- [x] Hide term-only styling options (border, shape, size) for relation-scoped XFields
- [x] Show line color option for relation-scoped XFields
- [x] Add `date` field type to XFields
- [x] Apply XField values to relations in the sidebar
- [x] Filter relations by XField values in advanced filtering
- [x] Apply line color styling based on XField values
...
- **Solution:**
  - **Timeline View:** A bottom-panel slider that filters the graph based on dates. "Show me the network state in _2024_ vs _2025_."
